...
public class JsonUtil {
    ...
    public static String getJSONString(Object object,String[]fields) throws Exception {
        JsonConfig jsonConfig=new JsonConfig();
        jsonConfig.setJsonPropertyFilter(new IgnoreFieldProcessorImpl(true, fields));//设置需要忽略的属性集合
        String jsonString = null;
